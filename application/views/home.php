<div class="col-md-6 offset-md-3 d-flex justify-content-center align-items-center min-vh-100 ">
	<div>
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="inputUsername" aria-describedby="inputUsername" placeholder="Masukan username">
	    <small id="inputUsername" class="form-text text-muted">Harap masukan Username dan Password yang benar</small>
	  </div>
	  <div class="form-group">
	    <label for="inputPassword">Password</label>
	    <input type="password" class="form-control" id="inputPassword" placeholder="Masukeun Password">
	  </div>
